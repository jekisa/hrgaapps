...
"[project]/app/api/notifikasi/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [data, unreadCount, total] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notifikasi$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().sort({
            createdAt: -1
...
async function POST(request) {
    ...
    if (body.markAllRead) {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notifikasi$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateMany({
            status: 'BELUM_DIBACA'
        }, {
            status: 'SUDAH_DIBACA'
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a970b5e._.js.map