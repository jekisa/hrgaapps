...
"[project]/app/api/notifikasi/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function PATCH(request, { params: paramsPromise }) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    const notif = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notifikasi$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(params.id, {
        status: 'SUDAH_DIBACA'
    }, {
        new: true
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(notif);
}
async function DELETE(request, { params: paramsPromise }) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Notifikasi$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(params.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b76194fb._.js.map