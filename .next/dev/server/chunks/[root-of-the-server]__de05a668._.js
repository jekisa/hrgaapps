...
"[project]/app/api/gedung/utilitas/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Utilitas$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
        jenis: 1,
        bulan: -1
    });
    const summary = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Utilitas$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
        {
            $match: {
                tahun
            }
...
async function POST(request) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Utilitas$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            jenis: body.jenis,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditLog"])(session.user.id, 'CREATE', 'UTILITAS', 'Tambah utilitas', (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIpAddress"])(request));
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Gagal menyimpan utilitas'
        }, {
            status: 500
        });
    }
...
async function PUT(request) {
    ...
    try {
        const body = await request.json();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Utilitas$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(body.id, {
            tagihan: body.tagihan ? parseFloat(body.tagihan) : null,
            penggunaan: body.penggunaan ? parseFloat(body.penggunaan) : null,
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditLog"])(session.user.id, 'UPDATE', 'UTILITAS', 'Update utilitas', (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIpAddress"])(request));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(record);
    } catch  {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Gagal update'
...
async function DELETE(request) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
    await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Utilitas$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de05a668._.js.map