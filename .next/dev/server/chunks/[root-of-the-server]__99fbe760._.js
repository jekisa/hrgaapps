...
"[project]/app/api/kendaraan/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const [total, data] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Kendaraan$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments(query),
        __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Kendaraan$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
            createdAt: -1
...
async function POST(request) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Kendaraan$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            noPol: body.noPol
        });
        ...
        const kendaraan = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$Kendaraan$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            noPol: body.noPol,
            merk: body.merk,
        ...
        if (body.tanggalPajakBerakhir) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$PembayaranPajak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditLog"])(session.user.id, 'CREATE', 'KENDARAAN', 'Tambah kendaraan', (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIpAddress"])(request));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(kendaraan, {
            status: 201
        });
    } catch (error) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99fbe760._.js.map