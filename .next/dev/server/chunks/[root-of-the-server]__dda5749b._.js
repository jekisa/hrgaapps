...
"[project]/app/api/kendaraan/pajak/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$PembayaranPajak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(query).sort({
        tanggalJatuhTempo: 1
...
async function POST(request) {
    ...
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$PembayaranPajak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditLog"])(session.user.id, 'CREATE', 'PAJAK_KENDARAAN', 'Tambah pajak kendaraan', (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIpAddress"])(request));
...
async function PATCH(request) {
    ...
    try {
        const body = await request.json();
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const record = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$PembayaranPajak$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(body.id, {
            status: 'SUDAH',
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAuditLog"])(session.user.id, 'UPDATE', 'PAJAK_KENDARAAN', 'Bayar pajak kendaraan', (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$server$2d$utils$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIpAddress"])(request));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(record);
    } catch  {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Gagal bayar pajak'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dda5749b._.js.map