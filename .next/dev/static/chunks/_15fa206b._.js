...
"[project]/components/kendaraan/LogModal.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LogModal({ isOpen, onClose, onSaved }) {
    ...
    const { data: kendaraanResult } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "LogModal.useQuery": ()=>fetch('/api/kendaraan?limit=100').then({
                    "LogModal.useQuery": (r)=>r.json()
                }["LogModal.useQuery"])
        }["LogModal.useQuery"],
        enabled: isOpen,
        staleTime: 1000 * 60 * 5
    ...
    const { data: karyawanResult } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "LogModal.useQuery": ()=>fetch('/api/karyawan?limit=100').then({
                    "LogModal.useQuery": (r)=>r.json()
                }["LogModal.useQuery"])
        }["LogModal.useQuery"],
        enabled: isOpen,
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Log perjalanan disimpan');
            onSaved();
        } catch (err) {
...
_s(LogModal, "0GcoNAfC09sJwiI1mVzVReLl2lI=", false, function() {
    return [
...
"[project]/app/(dashboard)/kendaraan/log-perjalanan/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$LogModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/kendaraan/LogModal.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function LogPerjalananPage() {
    ...
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "LogPerjalananPage.useQuery": ()=>fetch(`/api/kendaraan/log-perjalanan?page=${page}&limit=${pageSize}`).then({
                    "LogPerjalananPage.useQuery": (r)=>r.json()
                }["LogPerjalananPage.useQuery"])
        }["LogPerjalananPage.useQuery"],
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LogPerjalananPage.useMemo[columns]": ()=>[
                {
                    accessorKey: 'tanggal',
                    header: 'Tanggal',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ getValue })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue(), 'dd/MM/yyyy')
                    }["LogPerjalananPage.useMemo[columns]"]
                },
                {
                    id: 'kendaraan',
                    header: 'Kendaraan',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                },
                {
                    ...
                    header: 'Pengemudi',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ row })=>row.original.karyawan?.nama || row.original.keperluan || '-'
                    }["LogPerjalananPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'tujuan',
                    header: 'Tujuan',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ getValue })=>getValue() || '-'
                    }["LogPerjalananPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'kmAwal',
                    header: 'KM Awal',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ getValue })=>getValue() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(getValue()) : '-'
                    }["LogPerjalananPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'kmAkhir',
                ...
                },
                {
                    ...
                    header: 'Total KM',
                    cell: {
                        "LogPerjalananPage.useMemo[columns]": ({ getValue })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: "font-semibold",
                                children: getValue() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(getValue()) : '-'
                            }, void 0, false, {
                                fileName: "[project]/app/(dashboard)/kendaraan/log-perjalanan/page.js",
                                lineNumber: 68,
                                columnNumber: 31
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-2xl font-bold text-gray-900 mt-1",
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(totalKm),
                                    " km"
                                ]
                            }, void 0, true, {
                                fileName: "[project]/app/(dashboard)/kendaraan/log-perjalanan/page.js",
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$LogModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                isOpen: showModal,
...
_s(LogPerjalananPage, "wCznksnKEeAlUUIBSPwji0b6SxE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$QueryClientProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQueryClient"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
_c = LogPerjalananPage;
var _c;
__turbopack_context__.k.register(_c, "LogPerjalananPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_15fa206b._.js.map