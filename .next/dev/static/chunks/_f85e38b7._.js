...
"[project]/components/kendaraan/KendaraanModal.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function KendaraanModal({ isOpen, onClose, onSaved, editData }) {
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(id ? 'Kendaraan diperbarui' : 'Kendaraan ditambahkan');
            onSaved();
        } catch (err) {
...
_s(KendaraanModal, "LW+C9F5nt5IAl6XKm+3FCsPd5fQ=", false, function() {
    return [
...
_c = KendaraanModal;
var _c;
__turbopack_context__.k.register(_c, "KendaraanModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/(dashboard)/kendaraan/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$KendaraanModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/kendaraan/KendaraanModal.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function KendaraanPage() {
    ...
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "KendaraanPage.useQuery": ()=>fetch(`/api/kendaraan?${params}`).then({
                    "KendaraanPage.useQuery": (r)=>r.json()
                }["KendaraanPage.useQuery"])
        }["KendaraanPage.useQuery"],
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "KendaraanPage.useMutation[deleteMutation]": (id)=>fetch(`/api/kendaraan/${id}`, {
                    method: 'DELETE'
                }).then({
                    "KendaraanPage.useMutation[deleteMutation]": (r)=>r.json()
                }["KendaraanPage.useMutation[deleteMutation]"])
        }["KendaraanPage.useMutation[deleteMutation]"],
        onSuccess: {
            "KendaraanPage.useMutation[deleteMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Kendaraan berhasil dihapus');
        ...
        onError: {
            "KendaraanPage.useMutation[deleteMutation]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Gagal menghapus kendaraan')
        }["KendaraanPage.useMutation[deleteMutation]"]
    });
        ...
        "KendaraanPage.useMemo[columns]": ()=>[
                {
                    ...
                    header: 'No Polisi',
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ getValue })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                },
                {
                    ...
                    accessorKey: 'merk',
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                },
                {
                    ...
                    header: 'Tahun',
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ getValue })=>getValue() || '-'
                    }["KendaraanPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'status',
                ...
                },
                {
                    ...
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ getValue })=>{
                            const val = getValue();
                            if (!val) return '-';
                            const diff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDaysDiff"])(val);
                            const soon = diff !== null && diff <= 30;
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                className: soon ? 'text-red-600 font-semibold' : '',
                                children: [
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(val, 'dd/MM/yyyy'),
                                    soon && diff >= 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                },
                {
                    ...
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ getValue })=>getValue() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue(), 'dd/MM/yyyy') : '-'
                    }["KendaraanPage.useMemo[columns]"]
                },
                {
                    id: 'aksi',
                    ...
                    cell: {
                        "KendaraanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "KendaraanPage.useMemo[columns]": ()=>setDeleteId(row.original._id || row.original.id)
                                        }["KendaraanPage.useMemo[columns]"],
...
_s(KendaraanPage, "geHOKp2pmNuok+/9hem9rOj2ypA=", false, function() {
    return [
...
_c = KendaraanPage;
var _c;
__turbopack_context__.k.register(_c, "KendaraanPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_f85e38b7._.js.map