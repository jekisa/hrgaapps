...
"[project]/app/(dashboard)/karyawan/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function KaryawanPage() {
    ...
    const [deptFilter, setDeptFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "KaryawanPage.useQuery": ()=>fetch(`/api/karyawan?${params}`).then({
                    "KaryawanPage.useQuery": (r)=>r.json()
                }["KaryawanPage.useQuery"])
        }["KaryawanPage.useQuery"],
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "KaryawanPage.useMutation[deleteMutation]": (id)=>fetch(`/api/karyawan/${id}`, {
                    method: 'DELETE'
                }).then({
                    "KaryawanPage.useMutation[deleteMutation]": (r)=>r.json()
                }["KaryawanPage.useMutation[deleteMutation]"])
        }["KaryawanPage.useMutation[deleteMutation]"],
        onSuccess: {
            "KaryawanPage.useMutation[deleteMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Karyawan berhasil dihapus');
        ...
        onError: {
            "KaryawanPage.useMutation[deleteMutation]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Gagal menghapus karyawan')
        }["KaryawanPage.useMutation[deleteMutation]"]
    });
        ...
        "KaryawanPage.useMemo[columns]": ()=>[
                {
                    ...
                    header: 'NIK',
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ getValue })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                },
                {
                    ...
                    enableSorting: true,
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                },
                {
                    ...
                    header: 'Jabatan',
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ getValue })=>getValue() || '-'
                    }["KaryawanPage.useMemo[columns]"]
                },
                {
                ...
                },
                {
                    ...
                    header: 'Tgl Masuk',
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ getValue })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue(), 'dd/MM/yyyy')
                    }["KaryawanPage.useMemo[columns]"]
                },
                {
                    ...
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ getValue })=>{
                            const val = getValue();
                            if (!val) return '-';
                    ...
                    cell: {
                        "KaryawanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "KaryawanPage.useMemo[columns]": ()=>setDeleteId(row.original._id || row.original.id)
                                        }["KaryawanPage.useMemo[columns]"],
...
_s(KaryawanPage, "CPrlVZMLo/WY1WZ7yMKRFFgirvk=", false, function() {
    return [
...
_c = KaryawanPage;
var _c;
__turbopack_context__.k.register(_c, "KaryawanPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_a695f574._.js.map