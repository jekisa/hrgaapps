...
"[project]/components/kendaraan/JadwalModal.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function JadwalModal({ isOpen, onClose, onSaved }) {
    ...
    const { data: kendaraanResult } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "JadwalModal.useQuery": ()=>fetch('/api/kendaraan?status=TERSEDIA&limit=100').then({
                    "JadwalModal.useQuery": (r)=>r.json()
                }["JadwalModal.useQuery"])
        }["JadwalModal.useQuery"],
        enabled: isOpen
    });
    const kendaraanList = kendaraanResult?.data || [];
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "JadwalModal.useEffect": ()=>{
            if (isOpen) reset({
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Jadwal dibuat');
            onSaved();
        } catch (err) {
...
_s(JadwalModal, "d1dK+xpt8CCYN6SiBILnWpFF4Rg=", false, function() {
    return [
...
_c = JadwalModal;
var _c;
__turbopack_context__.k.register(_c, "JadwalModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/(dashboard)/kendaraan/jadwal/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$JadwalModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/kendaraan/JadwalModal.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function JadwalKendaraanPage() {
    ...
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "JadwalKendaraanPage.useQuery": ()=>fetch(`/api/kendaraan/jadwal?${params}`).then({
                    "JadwalKendaraanPage.useQuery": (r)=>r.json()
                }["JadwalKendaraanPage.useQuery"])
        }["JadwalKendaraanPage.useQuery"],
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "JadwalKendaraanPage.useMutation[updateMutation]": ({ id, status })=>fetch('/api/kendaraan/jadwal', {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    ...
                    "JadwalKendaraanPage.useMutation[updateMutation]": (r)=>r.json()
                }["JadwalKendaraanPage.useMutation[updateMutation]"])
        }["JadwalKendaraanPage.useMutation[updateMutation]"],
        onSuccess: {
            "JadwalKendaraanPage.useMutation[updateMutation]": ()=>{
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('Status diperbarui');
        ...
        onError: {
            "JadwalKendaraanPage.useMutation[updateMutation]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Gagal update status')
        }["JadwalKendaraanPage.useMutation[updateMutation]"]
    });
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "JadwalKendaraanPage.useMemo[columns]": ()=>[
                {
                    id: 'kendaraan',
                    header: 'Kendaraan',
                    cell: {
                        "JadwalKendaraanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                },
                {
                    ...
                    header: 'Pengemudi',
                    cell: {
                        "JadwalKendaraanPage.useMemo[columns]": ({ getValue })=>getValue() || '-'
                    }["JadwalKendaraanPage.useMemo[columns]"]
                },
                {
                    id: 'tujuan',
                ...
                },
                {
                    ...
                    header: 'Berangkat',
                    cell: {
                        "JadwalKendaraanPage.useMemo[columns]": ({ getValue })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue(), 'dd/MM/yyyy HH:mm')
                    }["JadwalKendaraanPage.useMemo[columns]"]
                },
                {
                    ...
                    header: 'Kembali',
                    cell: {
                        "JadwalKendaraanPage.useMemo[columns]": ({ getValue })=>getValue() ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue(), 'dd/MM/yyyy HH:mm') : '-'
                    }["JadwalKendaraanPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'status',
                                ...
                                children: [
                                    row.original.status === 'TERJADWAL' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: {
                                                    "JadwalKendaraanPage.useMemo[columns]": ()=>updateMutation.mutate({
                                                            id: row.original.id,
                                                            status: 'BERLANGSUNG'
                                                        })
                                                }["JadwalKendaraanPage.useMemo[columns]"],
                                    ...
                                    row.original.status === 'BERLANGSUNG' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        onClick: {
                                            "JadwalKendaraanPage.useMemo[columns]": ()=>updateMutation.mutate({
                                                    id: row.original.id,
                                                    status: 'SELESAI'
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$JadwalModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                isOpen: showModal,
...
_s(JadwalKendaraanPage, "rrCLUrVJLd3QxehoyVyXbO9zUYA=", false, function() {
    return [
...
_c = JadwalKendaraanPage;
var _c;
__turbopack_context__.k.register(_c, "JadwalKendaraanPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_414a4251._.js.map