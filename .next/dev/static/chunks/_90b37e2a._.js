...
"[project]/components/kendaraan/PerawatanModal.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PerawatanModal({ isOpen, onClose, onSaved, editData }) {
    ...
    const { data: kendaraanResult } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PerawatanModal.useQuery": ()=>fetch('/api/kendaraan?limit=100').then({
                    "PerawatanModal.useQuery": (r)=>r.json()
                }["PerawatanModal.useQuery"])
        }["PerawatanModal.useQuery"],
        enabled: isOpen,
        staleTime: 1000 * 60 * 5
    });
    ...
    const onSubmit = async (data)=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(editData ? 'Data diperbarui' : 'Jadwal perawatan ditambahkan');
            onSaved();
        } catch (err) {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: JENIS_PERAWATAN.map((j)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                            value: j,
...
_s(PerawatanModal, "d1dK+xpt8CCYN6SiBILnWpFF4Rg=", false, function() {
    return [
...
_c = PerawatanModal;
var _c;
__turbopack_context__.k.register(_c, "PerawatanModal");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/app/(dashboard)/kendaraan/perawatan/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$PerawatanModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/kendaraan/PerawatanModal.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function PerawatanPage() {
    ...
    const { data: result, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PerawatanPage.useQuery": ()=>fetch(`/api/kendaraan/perawatan?${params}`).then({
                    "PerawatanPage.useQuery": (r)=>r.json()
                }["PerawatanPage.useQuery"])
        }["PerawatanPage.useQuery"],
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PerawatanPage.useMemo[columns]": ()=>[
                {
                    id: 'kendaraan',
                    header: 'Kendaraan',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                },
                {
                    ...
                    header: 'Jenis',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ getValue })=>getValue()?.replace('_', ' ') || '-'
                    }["PerawatanPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'tanggal',
                    header: 'Tanggal',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ getValue })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(getValue())
                    }["PerawatanPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'bengkel',
                    header: 'Bengkel',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ getValue })=>getValue() || '-'
                    }["PerawatanPage.useMemo[columns]"]
                },
                {
                    ...
                    header: 'KM Servis',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ getValue })=>getValue() ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatNumber"])(getValue())} km` : '-'
                    }["PerawatanPage.useMemo[columns]"]
                },
                {
                ...
                },
                {
                    ...
                    header: 'Biaya',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ getValue })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(getValue())
                    }["PerawatanPage.useMemo[columns]"]
                },
                {
                    accessorKey: 'status',
                ...
                },
                {
                    ...
                    header: 'Aksi',
                    cell: {
                        "PerawatanPage.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: {
                                    "PerawatanPage.useMemo[columns]": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$kendaraan$2f$PerawatanModal$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                isOpen: showModal,
                onClose: ()=>{
                    setShowModal(false);
                    setEditData(null);
...
_s(PerawatanPage, "++n8GLxZKd+uhotdkztzvsboDEs=", false, function() {
    return [
...
_c = PerawatanPage;
var _c;
__turbopack_context__.k.register(_c, "PerawatanPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_90b37e2a._.js.map